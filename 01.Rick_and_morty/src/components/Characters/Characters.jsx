        ...
        <div className="row">
            ...
            {characters.map((char) => (
                ...
                >
                    <div
                        className={`
                        card h-100 shadow-lg border-0 rounded-4 overflow-hidden character-card animate__animated animate-entry ${darkMode ? "bg-dark text-light" : "bg-light text-dark" // aplica el modo oscuro o claro según el estado darkMode
                            }`}
                    >
